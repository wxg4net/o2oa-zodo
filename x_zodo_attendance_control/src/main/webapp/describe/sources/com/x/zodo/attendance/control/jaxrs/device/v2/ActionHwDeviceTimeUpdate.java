...
public class ActionHwDeviceTimeUpdate extends BaseAction {

    private static Logger logger = LoggerFactory.getLogger( ActionHwDeviceTimeUpdate.class );
    ...
    protected ActionResult<String> execute(HttpServletRequest request, EffectivePerson effectivePerson, String host, String time ) throws Exception {
        ...
        commandTemplate.setParam("time", time);
