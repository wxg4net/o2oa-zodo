...
public class ActionHwDeviceOpenDoor extends BaseAction {

    private static Logger logger = LoggerFactory.getLogger( ActionHwDeviceOpenDoor.class );
    ...
    protected ActionResult<String> execute(HttpServletRequest request, EffectivePerson effectivePerson, String host) throws Exception {
        ...
        CommandTemplate commandTemplate = new CommandTemplate("openDoor");
