...
public class ActionDeviceNet extends StandardJaxrsAction {

    private static Logger logger = LoggerFactory.getLogger( ActionDeviceNet.class );
    ...
    protected ActionResult<String> execute(HttpServletRequest request, EffectivePerson effectivePerson, String host, String time ) throws Exception {
        ...
        String commandTemplate = "GetNetInfo()\n";
