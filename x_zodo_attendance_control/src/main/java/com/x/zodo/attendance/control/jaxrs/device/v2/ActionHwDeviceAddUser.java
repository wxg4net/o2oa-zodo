...
public class ActionHwDeviceAddUser extends BaseAction {

    private static Logger logger = LoggerFactory.getLogger( ActionHwDeviceAddUser.class );
    ...
    protected ActionResult<String> execute(HttpServletRequest request, EffectivePerson effectivePerson, String host) throws Exception {
        ...
        CommandTemplate commandTemplate = new CommandTemplate("GetDeviceInfo");
