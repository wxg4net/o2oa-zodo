...
public class ActionHwDeviceManager extends BaseAction {

    private static Logger logger = LoggerFactory.getLogger( ActionHwDeviceManager.class );
    ...
    protected ActionResult<String> execute(HttpServletRequest request, EffectivePerson effectivePerson, String host) throws Exception {
        ...
        CommandTemplate commandTemplate = new CommandTemplate("GetManagerID");
